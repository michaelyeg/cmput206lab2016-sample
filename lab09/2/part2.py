...
def  WaveletFusion(C1, C2):
	...
	# --------Write your code-------
	C = np.zeros((len(C1),len(C1[0])),dtype='int64')
...
if __name__ == "__main__":
	...
	for i in range(0,3):
		...
		img1=fwt97_2d(im1_matrix[i],2)
		img2=fwt97_2d(im2_matrix[i],2)
		
		img1_c = np.array(img1)
		img2_c= np.array(img2)

		f = WaveletFusion(img1_c,img2_c)
			   
		channel = iwt97_2d(f,2)		
